...
\section*{Experience}
\textbf{Chief engineer and director}\\
\textit{Rose and Deer Software Ltd, July 2021 to present}\\[5pt]
Contract software engineer for multiple clients. Current project: working on a react typescript next-js frontend connecting to a python backend, to implement timed bookings for an events company. Previous project project: sole developer on react-native app for onsite operations in events company, creating simple flows for staff to be able to support customers.\\[10pt] 
